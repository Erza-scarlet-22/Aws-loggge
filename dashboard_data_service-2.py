...
def _resolve_date_filters(request_args):
    ...
    if preset == 'today':   return today, today, 'Today'
    if preset == 'week':    return today - timedelta(days=6),  today, 'Last 7 Days'
    if preset == 'month':   return today - timedelta(days=29), today, 'Last 30 Days'
    if preset == 'quarter': return today - timedelta(days=89), today, 'Last 90 Days'
